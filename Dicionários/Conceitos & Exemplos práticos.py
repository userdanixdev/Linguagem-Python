...
Usando repetição :
	...
	for k, v in filme.items():
		print(f'O{k} é {v}')   - # Irá fazer o looping até acabar todos os elementos. Terminando o laço, terminando a estrutura de repetição.

Podemos juntar listas,  tuplas e dicionários.***
As listas podem ser identificados por números e dicionários por textos. Assim também por números.

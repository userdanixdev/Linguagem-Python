...
class AnaliseNome:
    ...
    def analise_textos_1(self):
        ...
        self.nome=input('Digite seu nome completo: ').strip()
        sleep(0.9)
    ...
    def casos_especiais(self):
        ...
        print('Sem o uso do split, temos o comprimento com os espaços.')
        print(f'Comprimento com espaços, removendo a função strip: {(len("".join(self.nome)))} letras. ')
